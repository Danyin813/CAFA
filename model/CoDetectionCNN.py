...
class CoDetectionCNN(nn.Module):
    ...
    def forward(self, x, diff=True):
        ...
        if diff:
            # decoder2
            up1_diff = self.up1_diff(down4, down3) # B 256 64 64
            up2_diff = self.up2_diff(up1_diff, down2) # B, 128, 128, 128
            up3_diff = self.up3_diff(up2_diff, down1_1, down1_2)# B, 64, 256, 256
            up4_diff = self.up4_diff(up3_diff, down0_1, down0_2)# B, 32, 512, 512
            out_diff = self.out_diff(up4_diff) # B, 2, 512, 512
            return out_1, out_2, out_diff, up4_1, up4_2, up4_diff
        else:
            return out_1, out_2, up4_1, up4_2
