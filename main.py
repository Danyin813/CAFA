...
LastEditTime: 2023-02-15 17:42:18
'''
...
from dataset.target_dataset_aug import targetDataSet
...
from utils.show import show_training, show_training2
...
def feature_alignment(fea_src, fea_tgt, gt_src, threshold=0.7):
    ...
    if proto.shape[0] == 2:
        ...
        seg_tgt = torch.einsum('nd,md->nm', fea_tgt_emb, proto)  # 这行代码是干什么，求欧拉距离？咋求的
